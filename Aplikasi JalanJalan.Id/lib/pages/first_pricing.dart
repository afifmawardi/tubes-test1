    ...
    Widget option(
      ...
      return GestureDetector(
        ...
        child: Container(
          ...
          child: Padding(
            padding: const EdgeInsets.only(
                top: 16.0, left: 17, bottom: 23, right: 40),
            child: Row(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              header(),
              SizedBox(height: 50),
              option(0, 'assets/icon_location.png', 'Kota Bandung',
                  'Jawa Barat', '10 Tempat Terdaftar'),
              SizedBox(height: 24),
              option(1, 'assets/icon_location.png', 'Semarang', 'Jawa Tengah',
                  '10 Tempat Terdaftar'),
              SizedBox(height: 24),
              option(2, 'assets/icon_location.png', 'Bali', 'Bali',
                  '20 Tempat Terdaftar'),
            ],
          ),
        ),
